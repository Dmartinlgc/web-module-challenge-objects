...
console.log(createMenuItem('burger', 4,'dinner'));
...
*/
reviews.push({name:'Karen', rating: 0.0, feedback:'It was all out war!!! these sheeple demanded I wear a mask, and even called me rude when I sneezed on them.',});
console.log(reviews);
